...
const MENU = {
  ...
  assiettes: [
    { id:"a1", name:"Côte de Boeuf", hasCuisson:true, desc:"Maturée 15 jours ~350-400g + crudités", price:21.00, sideChoice:true, hasSauces:true, hasSupplements:true, hasCrudites:true, allergenes:[] },
    { id:"a2", name:"Entrecôte", hasCuisson:true, desc:"Maturée 15 jours ~220g + crudités", price:17.00, sideChoice:true, hasSauces:true, hasSupplements:true, hasCrudites:true, allergenes:[] },
    { id:"a3", name:"Brochettes (1 pièce)", hasCuisson:true, desc:"Onglet de boeuf 180g + crudités", price:14.00, sideChoice:true, hasSauces:true, hasSupplements:true, hasCrudites:true, allergenes:[] },
    { id:"a4", name:"Brochettes (2 pièces)", hasCuisson:true, hasCuisson:true, desc:"Onglet de boeuf 180g x2 + crudités", price:20.00, sideChoice:true, hasSauces:true, hasSupplements:true, hasCrudites:true, allergenes:[] },
